...
const SignupPage = () => {
  ...
  return (
    <div className="flex justify-center font-libre items-center min-h-screen px-4 py-6 sm:py-12">
      <div className="area">
      ...
      >
        <div className="p-6 sm:p-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-center bg-purple-400 text-transparent bg-clip-text">
            Join EESA
          </h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col sm:flex-row sm:gap-3">
              <div className="w-full sm:w-1/2 relative mb-6">
                ...
                >
                  ...
                  <option
                    value="B.Tech"
                    className="text-white bg-gray-800 py-2"
                  >
                    B.Tech
                  </option>
                  <option
            ...
            >
              {isLoading ? (
                <Loader className="animate-spin mx-auto size-5 sm:size-6" />
              ) : (
                "Create Account"
              )}
            </motion.button>
