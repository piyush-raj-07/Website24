        ...
        <div className="max-w-4xl mx-auto bg-white bg-opacity-5 border-2 border-white backdrop-blur-sm text-white p-8 rounded-lg shadow-2xl z-10 mt-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex flex-col">
              <label htmlFor="title" className="font-raleway font-semibold text-lg">Blog Title</label>
              <input
                type="text"
                id="title"
                name="title"
            ...
            <div className="flex flex-col">
              <label htmlFor="body" className="font-raleway font-semibold text-lg">Blog Body</label>
              <textarea
                id="body"
                name="body"
                value={formData.body}
            ...
            <div className="flex flex-col">
              <label htmlFor="cat" className="font-raleway font-semibold text-lg">Category</label>
              <select
                id="cat"
                name="cat"
                value={formData.cat}
            ...
            <button 
              type="submit"
              className="w-full py-3 font-libre tracking-wide bg-purple-800 hover:bg-purple-700 text-white font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transform transition-all duration-300 hover:scale-105"
            >
              Publish Blog
            </button>
            <button
